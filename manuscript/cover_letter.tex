...
powers a thermally driven spin valve: with antiparallel lead magnetizations the coherent
transmission, and hence the thermocurrent, vanishes identically across the window, an OFF
state enforced by the lead spectra rather than by interface details. The magnetic edges and
