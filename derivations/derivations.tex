...
(plus its conjugate). Matching to $\delta^2H_{\rm spin}=\sum J_{ij}\theta_i\theta_j$ gives the
LKAG formula
\begin{equation}
...
\end{equation}
This yields $|J_1|\gg|J_2|$ ($\sim$ tens and $\sim\!1$~meV) with ferromagnetic edge alignment---the
